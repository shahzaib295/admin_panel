$(function () {
  ...
  gradientStroke1.addColorStop(0, '#fd3550');
  gradientStroke1.addColorStop(1, '#fd3550');

  var gradientStroke2 = ctx.createLinearGradient(0, 0, 0, 300);
  gradientStroke2.addColorStop(0, '#0dcaf0');
  gradientStroke2.addColorStop(1, '#0dcaf0');
  ...
  // chart total_convo
  var ctx = document.getElementById("total_convo").getContext('2d');
  ...
  // chart 7
  var ctx = document.getElementById('chart7a').getContext('2d');

  var gradientStroke2 = ctx.createLinearGradient(0, 0, 0, 300);
  gradientStroke2.addColorStop(0, '#f7971e');
  gradientStroke2.addColorStop(1, '#ffd200');
...
function info_noti() {
  Lobibox.notify('default', {
    ...
    msg: 'This is Strong Mama Admin Dashboard'
  });
} 